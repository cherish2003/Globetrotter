...
const World = lazy(() =>
  import("../home/globe").then((m) => ({ default: m.World }))
);
...
export function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto  bg-white relative w-full mt-14">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          ...
          <p className="text-center text-base md:text-lg font-normal text-neutral-700 max-w-md mt-2 mx-auto">
            Crack clues, discover destinations, and challenge your friends.
            Ready to be the ultimate Globetrotter? ✈️
          </p>
        </motion.div>
